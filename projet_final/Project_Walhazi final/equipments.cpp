...
QStandardItemModel * Equipments::afficher() {
 ...
 bool Equipments::Add_element(QString id , QString name , QString type , int qnt , QString disp, QString desc) {
 ...
 bool Equipments::Modify_element(QString id , QString name , QString type , int qnt , QString disp, QString desc) {
