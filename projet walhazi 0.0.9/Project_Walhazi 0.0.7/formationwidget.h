...
#include <QDate>
#include <QVBoxLayout>
#include <QPixmap> // Add QPixmap for handling images
#include <QDebug>
#include <QByteArray> // Add QByteArray for handling image data
...
struct FormationData {
    ...
    QString description;
    int nbParticipants;
    QByteArray imageData; // Add QByteArray to store image data
};
...
private:
    ...
    QLabel *imageLabel; // Add QLabel for displaying image
    QVBoxLayout *layout;
